    ...
    private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions) {
        ...
        for (int i = 0; i < codes.Count; i++) {
            ...
            if (i + 2               < codes.Count                                   &&
                ...
                codes[i + 1].operand.ToString().Contains("elapsedFissureStateTics") &&
            ...
            if (i + 3               < codes.Count                                 &&
                ...
                codes[i + 1].operand.ToString().Contains("get_automationEnabled") &&
                ...
                if (codes[i + 3].opcode == OpCodes.Ldarg_0                              &&
                    ...
                    codes[i + 4].operand.ToString().Contains("elapsedFissureStateTics") &&
